    ...
    <div class="container">
        <div class="row">
            ...
            <div class="post-container">
                    <?php
                    $author_id = $_GET['aid'];
                    $sql1 = "SELECT * FROM post INNER JOIN user
                    ...
                    $sql = "SELECT p.post_id, p.title, p.description, p.post_date ,c.category_name,p.author, p.post_img, p.category, u.username FROM post AS p
